		...
		<div class="row">
			<div class="col-lg-6 col-md-6">
				<form method="post" action="contact.php" id="contact">  
					<fieldset>
						<legend id="title-left">Please sign up on our guest list</legend><br>
						...
						<input class="input-form" id="contact_value_email" type="text" name="contact_value_email">
			...
			<!-- <div class="col-lg-5 col-md-6">
				<form method="post" action="contact.php" id="calculator">
					<fieldset>
						...
						Interest Rate: <input type="number" name="rate"> <br><br>
						<div id="payment"></div>
						<br>
